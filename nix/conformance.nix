...
let
  version = "a3ee00672dd1b58c2b5a7d5e8b9e4a7b9e53ec1e";
  ...
  tests = {
    ...
    lossless_pfm = {
      ...
      icc = "d7f9e32ac2a06a7e3865a828e865dafb7cf1947584d3c06ec97a660c59786b51";
    };
    lz77_flower = {
  ...
  conformance = fetchFromGitHub {
    ...
    repo = "conformance";
    rev = version;
    hash = "sha256-qMEHTBvCT+P4QnsgdKOQvKhiiAd71LwGsfwBL0Lv0O4=";
  };
in
